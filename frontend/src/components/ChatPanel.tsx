  ...
  return (
    <section className="max-w-2xl mx-auto mb-8 rounded-2xl border border-neutral-800 bg-neutral-900/40 p-4 animate-pop-in">
      ...
      >
        ...
        />
        <button className="inline-flex items-center gap-2 rounded-lg bg-neutral-100 px-3 py-2 text-sm font-medium text-neutral-900 hover:bg-neutral-200 transition active:scale-[0.98] disabled:opacity-50" disabled={!configured || busy || !message.trim()} type="submit">
